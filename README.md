# Biconomy-Particle Integration with Next.js

This is a [Next.js](https://nextjs.org/) project that demonstrates the integration of Biconomy for gasless transactions and Particle for user authentication. It allows you to interact with a smart contract on the Polygon Mumbai test network.
...
* [Particle](https://particle.network/): A user friendly login solution using MPC-TSS with enhanced security.
...
* [Particle Documentation](https://docs.particle.network/): Learn how to use Particle for user authentication.
